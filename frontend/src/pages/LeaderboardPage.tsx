    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6 bg-away-moss/40 border border-away-gold/30 rounded-lg px-4 py-3 flex gap-3 items-start">
        ...
        <p className="text-away-cream/70 text-sm leading-snug">
          <span className="text-away-gold font-semibold">Scores are provisional</span> during the group stage. Only groups where all official standings have been entered are scored — groups still in progress count as 0 points until finalised. Standings will shift as more matches are played.
        </p>
      </div>
